...
class BenchmarkSuite:
    ...
    def run_all(self, n_patterns: int = 20, training_reps: int = 10,
        ...
        logger.info("Benchmark 1/6: CrossModalRecall (%d patterns x %d reps)", n_patterns, training_reps)
        ...
        return _to_native({
            ...
            "concept_separability": cs, "cross_modal_binding_accuracy": ba,
        })
    ...
    def summary(results: dict[str, Any]) -> str:
        ...
        lines += [f"6. Cross-Modal Binding Accuracy",
